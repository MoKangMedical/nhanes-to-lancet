...
1. **构建镜像**
```bash
docker build -t nhanes-to-lancet .
```

2. **运行容器**
```bash
docker run -d -p 8000:8000 --name nhanes-to-lancet nhanes-to-lancet
```
...
- **项目主页**: https://github.com/MoKangMedical/nhanes-to-lancet
- **问题反馈**: https://github.com/MoKangMedical/nhanes-to-lancet/issues
